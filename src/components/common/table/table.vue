...
<script>
    ...
    export default {
        ...
        props: {
            ...
            size: {
                validator (value) {
                    return 'default'//oneOf(value, ['small', 'large', 'default']);
                }
            },
            width: {
                type: [Number, String]
...
//                    style.height = this.scrollBarWidth > 0 ? `${this.bodyHeight}px` : `${this.bodyHeight - 1}px`;
        ...
        methods: {
            ...
            handleResize (narrow) {
                this.narrow+=narrow;
                this.$nextTick(() => {
                    const allWidth = !this.columns.some(cell => !cell.width)+this.narrow;    // each column set a width
                    if (allWidth) {
            ...
            emitDrag(borderLeft , deltaX , index){
                ...
                if (borderLeft === false) {
                    ...
                    for(let i=0;i<2;i++){
                        ...
                        obj.width = i%2?originWidth:originWidth+deltaX;
